...
// Define the setpoint (center of the line)
double setpoint = 512;
...
void setup() {
  ...
  pid.SetOutputLimits(-255, 255); // Adjust these limits according to your motor driver

  // Start the PID controller
  pid.SetSampleTime(10); // Update the PID every 10ms
